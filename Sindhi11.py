...
os.system('xdg-open https://facebook.com/Page/100067067947053/')
...
----------------------------------------------
 Author    : Rashid BALOCH 
 Github    : Rashid78
 Facebook  : Lala.Rashid.Shar
 Tool Name : Rashid-King
 Type type : FREE
 Version   : 1.9.8
----------------------------------------------
 Rashid sindhi version 1.9.8
 For Haters: Tumhare Okat Nhi Mera samne 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923206691045&text="
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Sindhi-RS] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
